...
cat ../.github/workflows/ubuntu_26.04/expected_gdalinfo_formats.txt ../.github/workflows/ubuntu_26.04/expected_ogrinfo_formats.txt > expected_formats.txt
...
diff -u arg_names.txt ../.github/workflows/ubuntu_26.04/reference_arg_names.txt >/dev/null || (echo "Unexpected argument names found in algorithms. If intended, update .github/workflows/ubuntu_26.04/reference_arg_names.txt:"; diff -u arg_names.txt ../.github/workflows/ubuntu_26.04/reference_arg_names.txt; /bin/false)
