// NOTE: for GDAL, this is an extract from the https://github.com/sheredom/utf8.h
// code
...
utf8codepoint(const utf8_int8_t *utf8_restrict str,
  ...
  return const_cast<utf8_int8_t *>(str);
}
...
utf8rcodepoint(const utf8_int8_t *utf8_restrict str,
               utf8_int32_t *utf8_restrict out_codepoint) {
  const utf8_int8_t *s = static_cast<const utf8_int8_t *>(str);
  ...
  return const_cast<utf8_int8_t *>(s);
}
