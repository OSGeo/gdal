...

{
    ...
    poDriver->SetMetadataItem(
        ...
        "    <Value>NO</Value>"
        "  </Option>"
        "  <Option name='SCHEMA' type='string' description='"
        "   Override one or more field types by providing a JSON map of field "
        "names and types. "
        "   This can be a filename or a JSON string."
        "   or a URL.  If not provided, no validation is done.'/>"
