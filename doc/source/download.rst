...
* **2026-07-22** `gdal-3.13.2.tar.gz`_ `3.13.2 Release Notes`_ (`3.13.2 md5`_, `3.13.2 sig`_)

.. _`3.13.2 Release Notes`: https://github.com/OSGeo/gdal/blob/v3.13.2/NEWS.md
.. _`gdal-3.13.2.tar.gz`: https://github.com/OSGeo/gdal/releases/download/v3.13.2/gdal-3.13.2.tar.gz
.. _`3.13.2 md5`: https://github.com/OSGeo/gdal/releases/download/v3.13.2/gdal-3.13.2.tar.gz.md5
.. _`3.13.2 sig`: https://github.com/OSGeo/gdal/releases/download/v3.13.2/gdal-3.13.2.tar.gz.sig
