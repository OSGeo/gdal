...
This is a read-only driver that reads a JSON file containing a command line
of the :ref:`gdal command line interface <gdal_program>`, that results in a
on-the-fly / streamed raster dataset when this file is used as a input dataset
for :cpp:func:`GDALOpenEx`, or anywhere in GDAL API or command line utilities
...
indicates ``GDALG`` is a valid output format. This includes :ref:`gdal_raster_pipeline_subcommand`,
