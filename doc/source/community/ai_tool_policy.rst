...
If an issue was found or analyzed by a AI/LLM tool, the reporter must
confirm the findings of those tools with an actual reproducing test case,
not just a theoretical analysis, and summarize the information with their own
words and not post the raw output from the tool.
