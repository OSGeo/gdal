...
1. Download archives :file:`gdal-X.Y.Z.tar.gz` and :file:`gdalautotest-X.Y.Z.tar.gz` in a directory
...
6. Create a build directory and change into it: ``mkdir build; cd build``
