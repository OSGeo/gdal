...
``gdal raster pipeline ! .... ! write out.gdalg``.
...
.. example::
   ...
   .. code-block:: bash
        ...
        $ gdal raster pipeline --progress ! read in.tif ! reproject --dst-crs=EPSG:32632 ! write in_epsg_32632.gdalg --overwrite
        $ gdal raster info in_epsg_32632.gdalg
