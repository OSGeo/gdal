...
.. option:: -skipinvalid
    ...
    Run the :cpp:func:`OGRGeometry::IsValid` operation, after all other geometry
    operations, on geometries to check if they are valid regarding the rules of
    the Simple Features specification. If they are not, the feature is skipped.
