...
Each polygon is created with an attribute indicating the pixel value of that polygon. The mask
(either explicit, or implicit through nodata value or alpha band) associated
to the selected band will be used to determine the validity of pixels.
...
.. option:: --connectedness 4|8
    ...
    Whether to use 4-connectedness or 8-connectedness. Default is 4.
