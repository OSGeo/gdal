...
:program:`gdal manage-dataset identify` reports the data format of the
file by using the *identify* mode and specifying one or several data file names.
...
.. option:: -r, --recursive
    ...
    Recursively scan files/folders for files.

.. option:: --force-recursive

    Recursively scan folders for dataset files, forcing recursion in folders
