.. _gdal_vector_geom_simplify_coverage:

================================================================================
``gdal vector geom simplify-coverage``
================================================================================
...
.. program-output:: gdal vector geom simplify-coverage --help-doc

Description
-----------

:program:`gdal vector geom simplify-coverage` simplifies boundaries of a
...
of shared boundaries is not needed, :ref:`gdal_vector_geom_simplify` provides
...
.. example::
   ...
   .. code-block:: bash
        ...
        $ gdal vector geom simplify-coverage --tolerance=1 in.gpkg out.gpkg --overwrite
...
.. example::
   ...
   .. code-block:: bash
       ...
       $ gdal vector pipeline ! read tl_2024_us_state.shp !  geom simplify-coverage --tolerance 2 ! geom set-type --multi ! write out.gpkg --overwrite
