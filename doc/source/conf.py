...
man_pages = [
    ...
    (
        "programs/gdal_manage_dataset_identify",
    ...
    (
        "programs/gdal_manage_dataset_copy",
    ...
    (
        "programs/gdal_manage_dataset_rename",
    ...
    (
        "programs/gdal_manage_dataset_delete",
