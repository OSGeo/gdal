...
* `gdalinfo.java <https://github.com/OSGeo/gdal/tree/master/swig/java/apps/gdalinfo.java>`__ Sample Java program similar to gdalinfo utility (use API from Java bindings of GDAL 1.7.0dev)
