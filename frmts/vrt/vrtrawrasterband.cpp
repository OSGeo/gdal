...

{
        ...
        EQUAL(pszAllowedPaths, "SIBLING_OR_CHILD_OF_VRT_PATH"))
    {
        ...
        {
            CPLError(CE_Failure, CPLE_AppDefined,
                     "'%s' is rejected because the relativeToVRT flag not "
                     "being set and %s",
        ...
        {
            CPLError(CE_Failure, CPLE_AppDefined,
                     "'%s' is rejected because it is not relative to the VRT "
                     "path and %s",
                     pszFilename, pszErrorMsgPart);
            return CE_Failure;
        }
        ...
        {
            CPLError(CE_Failure, CPLE_AppDefined,
                     "'%s' is rejected because it may not be a sibling or "
    ...
    else
    {
        ...
        {
            CPLError(CE_Failure, CPLE_AppDefined,
                     "'%s' is rejected because the presence of ../ in it may "
        ...
        {
            CPLError(CE_Failure, CPLE_AppDefined,
                     "'%s' is rejected because it is not contained in one of "
                     "the allowed path(s)",
                     pszFilename);
            return CE_Failure;
        }
