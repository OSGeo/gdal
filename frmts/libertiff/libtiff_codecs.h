...
// Use code from internal libtiff for LZW and PackBits codecs
...
#pragma GCC diagnostic pop
    ...
    void LIBERTIFF_TIFFWarningExtR(TIFF *, const char *, const char *, ...)
    {
    }

    void LIBERTIFF_TIFFErrorExtR(TIFF *, const char *, const char *, ...)
    {
    }
}
#undef isTiled
