...
/* Pseudo tags */
#define TIFFTAG_JXL_LOSSYNESS                                                  \
    65565 /* Whether the compression should be lossless (default) or lossy */
#define JXL_LOSSLESS 0
#define JXL_LOSSY 1
#define TIFFTAG_JXL_EFFORT                                                     \
    65536 /* Level of effort for compressor: 1:lightning 2: thunder 3:falcon   \
             4:cheetah 5:hare 6:wombat 7:squirrel 8:kitten 9:tortoise. Default \
             is 5 */
