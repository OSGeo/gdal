...
echo "#ifndef GDAL_LIBTIFF_SYMBOL_RENAME_H_INCLUDED" >> $OUT_FILE
echo "#define GDAL_LIBTIFF_SYMBOL_RENAME_H_INCLUDED" >> $OUT_FILE
...
echo "#endif /* GDAL_LIBTIFF_SYMBOL_RENAME_H_INCLUDED */" >> $OUT_FILE
