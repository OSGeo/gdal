...
inline char *PrepareTIFFErrorFormat(const char *module, const char *fmt)
...
inline std::unique_ptr<GDALColorTable> TIFFColorMapTagToColorTable(
...
inline CPLStringList TIFFRPCTagToRPCMetadata(const double adfRPC[92])
{
    CPLStringList asMD;
