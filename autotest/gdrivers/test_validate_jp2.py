...
def test_validate_jp2_2():
    ...
    build_jp2_from_xml.build_file(
        "data/test_validate_jp2/byte_corrupted.xml", "/vsimem/out.jp2"
    )
    error_report = validate(
        "/vsimem/out.jp2", oidoc="data/test_validate_jp2/byte_oi.xml"
    )
    gdal.Unlink("/vsimem/out.jp2")

    expected_errors = [
        "ERROR[GeoJP2]: 2 GeoTIFF UUID box found",
...
def test_validate_jp2_3():
    ...
    expected_errors = [
        "ERROR[GMLJP2]: No GMLJP2 box found whereas it was expected",
...
def test_validate_jp2_7():
    ...
    error_report = validate(
        ...
        oidoc="data/test_validate_jp2/stefan_full_rgba_oi.xml",
