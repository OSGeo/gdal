...
def test_rcm_open_from_product_xml():
    ...
    assert new_got_md == {
        ...
        "BETA_NOUGHT_LUT": "calibration/lutBeta_VH.xml,calibration/lutBeta_VV.xml",
        "BITS_PER_SAMPLE": "16",
        "DATA_TYPE": "Integer",
        "FACILITY_IDENTIFIER": "inputDatasetFacilityId",
        "FAR_RANGE_INCIDENCE_ANGLE": "incAngFarRng",
        "FIRST_LINE_TIME": "zeroDopplerTimeFirstLine",
        "GAMMA_LUT": "calibration/lutGamma_VH.xml,calibration/lutGamma_VV.xml",
        ...
        "SIGMA_NOUGHT_LUT": "calibration/lutSigma_VH.xml,calibration/lutSigma_VV.xml",
