...
def test_gdalwarp_lib_mask_band_and_src_nodata():
    ...
    with gdaltest.error_raised(
        gdal.CE_Warning,
        match="Source dataset has both a per-dataset mask band and the warper has been also configured with a source nodata value. Only taking into account the later",
    ):
