...
# Purpose:  'gdal manage-dataset delete' testing
...
def test_gdalalg_manage_dataset_delete(tmp_vsimem):
...
def test_gdalalg_manage_dataset_delete_format(tmp_vsimem):
...
def test_gdalalg_manage_dataset_delete_error(tmp_vsimem):
...
def test_gdalalg_manage_dataset_copy_complete():
    ...
    out = gdaltest.runexternal(
        f"{gdal_path} completion gdal manage-dataset delete --format="
    )
    assert "GTiff " in out
