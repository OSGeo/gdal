...
def test_gdalalg_vector_geom_explode_collections_test_ogrsf(tmp_path):
    ...
    open(gdalg_filename, "wb").write(
        b'{"type": "gdal_streamed_alg","command_line": "gdal vector geom explode-collections ../ogr/data/poly.shp --output-format=stream foo","relative_paths_relative_to_this_file":false}'
    )
