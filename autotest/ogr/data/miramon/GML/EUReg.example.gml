...
<gml:FeatureCollection xmlns:net="http://inspire.ec.europa.eu/schemas/net/4.0"
        ...
        <EUReg:ProductionSite gml:id="_123456789.SITE">
            ...
            <EUReg:siteName>
                <EUReg:FeatureName>
					...
					<EUReg:nameOfFeature>EXAMPLE SITE 1 bis</EUReg:nameOfFeature>
                </EUReg:FeatureName>
            </EUReg:siteName>
            <EUReg:location>
	...
	<gml:featureMember>
        <EUReg:ProductionSite gml:id="_123456789.SITEkk">
            <pf:inspireId>
                <base:Identifier>
                    <base:localId>123456789.SITEkk</base:localId>
                    <base:namespace>ES.CAEDkk</base:namespace>
                </base:Identifier>
            </pf:inspireId>
            <pf:status xsi:nil="true"/>
            <EUReg:siteName>
                <EUReg:FeatureName>
                    <EUReg:nameOfFeature>EXAMPLE SITE 1kk</EUReg:nameOfFeature>
                </EUReg:FeatureName>
            </EUReg:siteName>
            <EUReg:location>
                <gml:Point gml:id="_av427559-abb7-4632-af1f-764e317723gf"
                ...
                <EUReg:CompetentAuthority>
                    ...
                    <EUReg:address>
                        <EUReg:AddressDetails>
							...
							<EUReg:buildingNumber>11</EUReg:buildingNumber>
                            <EUReg:city>MADRID</EUReg:city>
            ...
            <EUReg:competentAuthorityPermits>
                <EUReg:CompetentAuthority>
                    ...
                    <EUReg:address>
                        <EUReg:AddressDetails>
                            <EUReg:streetName>Ministry Street</EUReg:streetName>
                            <EUReg:buildingNumber>16</EUReg:buildingNumber>
                            <EUReg:city>MADRIT</EUReg:city>
