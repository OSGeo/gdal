...
gdal.Open('non_existing', gdal.OF_VECTOR)
gdal.Open('non_existing', gdal.OF_VECTOR | gdal.OF_UPDATE)
...
ds1 = None
ds1 = gdal.Open('/vsimem/test.csv', gdal.OF_VECTOR | gdal.OF_UPDATE)
ds1 = None
...
fdefn1 = ds1_lyr1.GetLayerDefn()
fdefn1.GetGeomType()
fdefn1.GetFieldCount()
fdefn1.GetFieldIndex('foo')
fdefn1_fielddefn1 = fdefn1.GetFieldDefn(1)
fdefn1_fielddefn1.GetType()
fdefn1_fielddefn1.GetNameRef()
fdefn1_fielddefn1.GetSubType()
fdefn1.GetGeomFieldCount()
fdefn1.GetGeomFieldIndex('foo')
fdefn1_geomfielddefn0 = fdefn1.GetGeomFieldDefn(0)
fdefn1_geomfielddefn0.GetType()
fdefn1_geomfielddefn0.GetNameRef()
fdefn1_geomfielddefn0.GetSpatialRef()
f = ogr.Feature(fdefn1)
f.SetField(0, 1)
f.SetField(1, 2.34)
f.SetField(2, 'bla')
