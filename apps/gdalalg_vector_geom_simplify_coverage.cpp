...
class GDALVectorGeomSimplifyCoverageOutputDataset
    : public GDALVectorNonStreamingAlgorithmDataset
{
  ...
  private:
    CPL_DISALLOW_COPY_ASSIGN(GDALVectorGeomSimplifyCoverageOutputDataset)
...
bool GDALVectorGeomSimplifyCoverageAlgorithm::RunStep(
    GDALVectorPipelineStepRunContext &)
{
    auto poSrcDS = m_inputDataset[0].GetDatasetRef();
    auto poDstDS =
        std::make_unique<GDALVectorGeomSimplifyCoverageOutputDataset>(m_opts);
