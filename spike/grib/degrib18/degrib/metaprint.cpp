 ...
 *****************************************************************************
 */
static char *Lookup (char **table, size_t n, size_t index)
{
   static char *def[] = { "Reserved", "Reserved for local use", "Missing" };
...
static int PrintGDS (gdsType *gds, int version)
{
   ...
   static char *table31[] = { "Latitude/Longitude", "Mercator",
...
static void PrintGridAttrib (gridAttribType *attrib, sChar decimal)
{
   ...
   static char *table51[] = { "Floating point", "Integer" };
