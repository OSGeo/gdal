...
find_path(PCRE2-8_INCLUDE_DIR NAMES pcre2.h)
...
find_package_handle_standard_args(PCRE2-8
                                  ...
                                  REQUIRED_VARS PCRE2-8_LIBRARY PCRE2-8_INCLUDE_DIR)
mark_as_advanced(PCRE2-8_INCLUDE_DIR PCRE2-8_LIBRARY)
if(PCRE2-8_FOUND)
    set(PCRE2-8_LIBRARIES ${PCRE2-8_LIBRARY})
    set(PCRE2-8_INCLUDE_DIRS ${PCRE2-8_INCLUDE_DIR})
    if(NOT TARGET PCRE2::PCRE2-8)
        add_library(PCRE2::PCRE2-8 UNKNOWN IMPORTED)
        set_target_properties(PCRE2::PCRE2-8 PROPERTIES
                              INTERFACE_INCLUDE_DIRECTORIES ${PCRE2-8_INCLUDE_DIR}
