...
MACRO(DOTNET_BUILD_COMMANDS)
    ...
    ELSE()
        ...
        LIST(APPEND build_dotnet_cmds
            COMMAND ${CMAKE_COMMAND} -E echo "build --no-restore -c ${DOTNET_CONFIG} ${DOTNET_BUILD_PROPERTIES} ${DOTNET_BUILD_OPTIONS} ${DOTNET_ARGUMENTS} ${DOTNET_PROJPATH}")
            ...
            COMMAND ${DOTNET_EXE} build --no-restore -c ${DOTNET_CONFIG} ${DOTNET_BUILD_PROPERTIES} ${DOTNET_BUILD_OPTIONS} ${DOTNET_ARGUMENTS} ${DOTNET_PROJPATH})
