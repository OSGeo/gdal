function(gdal_set_runtime_env res)
  ...
  if (WIN32)
    ...
    if (GTEST_DIR)
      set(GTEST_DIR_WITH_SEP "${GTEST_DIR}\\;")
    endif()
    list(APPEND RUNTIME_ENV "PATH=${GDAL_OUTPUT_DIR}\\;${GDAL_APPS_OUTPUT_DIR_WITH_SEP}${GTEST_DIR_WITH_SEP}${NATIVE_GDAL_PYTHON_SCRIPTS_DIR_WITH_SEP}${PATH_ESCAPED}")
  else ()
    if (Python_Interpreter_FOUND)
    ...
    list(APPEND RUNTIME_ENV "LD_LIBRARY_PATH=${GTEST_DIR_WITH_SEP}${GDAL_OUTPUT_DIR}:$ENV{LD_LIBRARY_PATH}")
  endif ()
