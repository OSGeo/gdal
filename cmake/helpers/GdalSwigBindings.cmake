...
function(gdal_swig_bindings)
  ...
  file(MAKE_DIRECTORY ${CMAKE_BINARY_DIR}/swig/${_SWIG_BINDING}/extensions)
  set(SWIG_ARGS -Wall ${_SWIG_ARGS} -I${CMAKE_SOURCE_DIR}/swig/include -I${CMAKE_SOURCE_DIR}/swig/include/${_SWIG_BINDING})
  # for gdalconst.i
  gdal_swig_binding_target(
          ...
          ${_SWIG_DEPENDS}
          ${CMAKE_SOURCE_DIR}/swig/include/${_SWIG_BINDING}/typemaps_${_SWIG_BINDING}.i
          ${CMAKE_SOURCE_DIR}/swig/include/gdalconst.i
  )
  ...
  foreach (tgt IN ITEMS gdal ogr osr gnm)
    gdal_swig_binding_target(
            ...
            ${_SWIG_DEPENDS}
            ${CMAKE_SOURCE_DIR}/swig/include/${_SWIG_BINDING}/typemaps_${_SWIG_BINDING}.i
            ${CMAKE_SOURCE_DIR}/swig/include/${tgt}.i
            ${CMAKE_SOURCE_DIR}/swig/include/${_SWIG_BINDING}/${tgt}_${_SWIG_BINDING}.i
    )
  endforeach ()
endfunction()
...
function(gdal_swig_binding_target)
  ...
  cmake_parse_arguments(_SWIG "${_options}" "${_oneValueArgs}" "${_multiValueArgs}" ${ARGN})
  if (_SWIG_CXX)
    set(_OUTPUT ${CMAKE_BINARY_DIR}/swig/${_SWIG_BINDING}/extensions/${_SWIG_TARGET}_wrap.cpp)
  else ()
    set(_OUTPUT ${CMAKE_BINARY_DIR}/swig/${_SWIG_BINDING}/extensions/${_SWIG_TARGET}_wrap.c)
  endif ()
  add_custom_command(
          ...
          -o ${_OUTPUT}
          ${CMAKE_SOURCE_DIR}/swig/include/${_SWIG_TARGET}.i
