...
if ((EXISTS "${CMAKE_SOURCE_DIR}/gcore/gdal_version.h") AND NOT ("${CMAKE_SOURCE_DIR}" STREQUAL "${CMAKE_BINARY_DIR}"))
...
add_custom_target(generate_gdal_version_h
                  COMMAND ${CMAKE_COMMAND}
                    ...
                    -P "${CMAKE_SOURCE_DIR}/cmake/helpers/generate_gdal_version_h.cmake"
                  VERBATIM)
