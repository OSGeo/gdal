...
function(add_gdal_driver)
    set(_options BUILTIN PLUGIN_CAPABLE NO_DEPS WFLAG_OLD_STYLE_CAST STRONG_CXX_WFLAGS CXX_WFLAGS_EFFCXX NO_CXX_WFLAGS NO_SHARED_SYMBOL_WITH_CORE SKIP_GDAL_PRIV_HEADER)
    ...
    elseif (_DRIVER_WFLAG_OLD_STYLE_CAST)
        target_compile_options(${_DRIVER_TARGET} PRIVATE $<$<COMPILE_LANGUAGE:CXX>:${GDAL_CXX_WARNING_FLAGS} ${WFLAG_OLD_STYLE_CAST}>)
