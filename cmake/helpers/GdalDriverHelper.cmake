            ...
            if(NOT ${TO_BE_REMOVED})
                ...
                if (NOT GDAL_IGNORE_FAILED_CONDITIONS)
                    ...
                    if( "${_dep}" MATCHES "OGR_ENABLE_DRIVER_" AND NOT ${OGR_BUILD_OPTIONAL_DRIVERS})
                        set(ERROR_MSG_EXTRA_HINT ", presumably because OGR_BUILD_OPTIONAL_DRIVERS=OFF was explicitly set. You may conditionaly enable the missing required driver by setting ${_dep}=ON")
                    elseif ( "${_dep}" MATCHES "GDAL_ENABLE_DRIVER_" AND NOT ${GDAL_BUILD_OPTIONAL_DRIVERS})
                        set(ERROR_MSG_EXTRA_HINT ", presumably because GDAL_BUILD_OPTIONAL_DRIVERS=OFF was explicitly set. You may conditionaly enable the missing required driver by setting ${_dep}=ON")
                    endif()
