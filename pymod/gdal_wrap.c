...
static PyObject *_wrap_GDALFillRaster(PyObject *self, PyObject *args) {
    ...
    self = self;
    if(!PyArg_ParseTuple(args,"Odd:GDALFillRaster",&_argo0,&_arg1,&_arg2)) 
        return NULL;
    if (_argo0) {
        if (_argo0 == Py_None) { _arg0 = NULL; }
        else if (SWIG_GetPtrObj(_argo0,(void **) &_arg0,(char *) 0 )) {
...
static PyObject *_wrap_OSRSetProjection(PyObject *self, PyObject *args) {
    ...
    self = self;
    if(!PyArg_ParseTuple(args,"Os:OSRSetProjection",&_argo0,&_arg1)) 
        return NULL;
    if (_argo0) {
        if (_argo0 == Py_None) { _arg0 = NULL; }
        else if (SWIG_GetPtrObj(_argo0,(void **) &_arg0,(char *) 0 )) {
...
static PyObject *_wrap_PyGDALGeneralCmdLineProcessor(PyObject *self, PyObject *args) {
    ...
    self = self;
    if(!PyArg_ParseTuple(args,"Oi:PyGDALGeneralCmdLineProcessor",&_argo0,&_arg1)) 
        return NULL;
    if (_argo0) {
        if (_argo0 == Py_None) { _arg0 = NULL; }
        else if (SWIG_GetPtrObj(_argo0,(void **) &_arg0,"_stringList")) {
...
static PyMethodDef _gdalMethods[] = {
	 ...
	 { "PyGDALGeneralCmdLineProcessor", _wrap_PyGDALGeneralCmdLineProcessor, METH_VARARGS },
	 ...
	 { "OSRSetProjection", _wrap_OSRSetProjection, METH_VARARGS },
	 ...
	 { "GDALFillRaster", _wrap_GDALFillRaster, METH_VARARGS },
	 ...
	 { "CPLFindFile", _wrap_CPLFindFile, METH_VARARGS },
	 { "CPLFinderClean", _wrap_CPLFinderClean, METH_VARARGS },
	 { "CPLPopFinderLocation", _wrap_CPLPopFinderLocation, METH_VARARGS },
	 { "CPLPushFinderLocation", _wrap_CPLPushFinderLocation, METH_VARARGS },
	 { "CPLSetConfigOption", _wrap_CPLSetConfigOption, METH_VARARGS },
	 { "CPLGetConfigOption", _wrap_CPLGetConfigOption, METH_VARARGS },
	 { "CSLDestroy", _wrap_CSLDestroy, METH_VARARGS },
	 { "CPLGetLastErrorMsg", _wrap_CPLGetLastErrorMsg, METH_VARARGS },
	 { "CPLGetLastErrorType", _wrap_CPLGetLastErrorType, METH_VARARGS },
