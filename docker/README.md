...
Tagged images of recent past releases are available. The last ones (at time of writing) are for GDAL 3.5.2 and PROJ 9.1.0, for linux/amd64 and linux/arm64:
* osgeo/gdal:alpine-small-3.5.2
* osgeo/gdal:alpine-normal-3.5.2
* osgeo/gdal:ubuntu-small-3.5.2
* osgeo/gdal:ubuntu-full-3.5.2
