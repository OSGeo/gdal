...
Tagged images of recent past releases are available. The last ones (at time of writing) are for GDAL 3.13.3 and PROJ 9.8.1, for linux/amd64 and linux/arm64:
* ghcr.io/osgeo/gdal:alpine-small-3.13.3
* ghcr.io/osgeo/gdal:alpine-normal-3.13.3
