...
class GDALRead
{
    ...
    public static void Main(string[] args)
    {
        ...
        if (args.Length == 3) iOverview = int.Parse(args[2], System.Globalization.CultureInfo.InvariantCulture);
    ...
    private static void SaveBitmapBuffered(Dataset ds, string filename, int iOverview)
    {
        ...
        // If this is a single band image save as a single band image
