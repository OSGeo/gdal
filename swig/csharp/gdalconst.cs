...
public class gdalconst {
  ...
  public static readonly string DMD_LONGNAME = gdalconstPINVOKE.get_DMD_LONGNAME();
  public static readonly string DMD_HELPTOPIC = gdalconstPINVOKE.get_DMD_HELPTOPIC();
  public static readonly string DMD_MIMETYPE = gdalconstPINVOKE.get_DMD_MIMETYPE();
  public static readonly string DMD_EXTENSION = gdalconstPINVOKE.get_DMD_EXTENSION();
  public static readonly string DMD_CREATIONOPTIONLIST = gdalconstPINVOKE.get_DMD_CREATIONOPTIONLIST();
  public static readonly string DMD_CREATIONDATATYPES = gdalconstPINVOKE.get_DMD_CREATIONDATATYPES();
  public static readonly string DCAP_CREATE = gdalconstPINVOKE.get_DCAP_CREATE();
  public static readonly string DCAP_CREATECOPY = gdalconstPINVOKE.get_DCAP_CREATECOPY();
