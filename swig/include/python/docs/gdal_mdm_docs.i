...
>>> ar.GuessGeoTransform(1, 0, False)  #(-179.6, 1.0, 0.0, 89.6, 0.0, -1.0)
>>> ar.GuessGeoTransform(0, 1, False)  #(89.6, -1.0, 0.0, -179.6, 0.0, 1.0)
>>> ar.GuessGeoTransform(1, 0, True)   #(-179.1, 1.0, 0.0, 89.1, 0.0, -1.0)
