...
%feature("docstring") GetInterBandCovarianceMatrix "

GetInterBandCovarianceMatrix(self,
                             approx_ok=False,
                             force=False,
                             write_into_metadata=True,
                             delta_degree_of_freedom=1,
                             callback=None,
                             callback_data=None) -> List[List[float]]
...
-------
List[List[float]]
    a list of self.RasterCount of lists of self.RasterCount values
...
%feature("docstring") ComputeInterBandCovarianceMatrix "

ComputeInterBandCovarianceMatrix(self,
                                 approx_ok=False,
                                 write_into_metadata=True,
                                 delta_degree_of_freedom=1,
                                 callback=None,
