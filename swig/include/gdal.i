...
%ignore GDALColorEntry;
%ignore GDALDriverManager;
%ignore GDALOptionDefinition;
%ignore GDALOpenInfo;
 
// Methods which are to be ignored.
%ignore GDALGetRasterMetadata;
%ignore GDALSetMetadata;
%ignore GDALSetMetadataItem;
%ignore GDALDefaultBuildOverviews;
%ignore GDALGetMetadata;
%ignore GDALGetRasterCategoryNames;
%ignore GDALGetColorEntry;
%ignore GDALGetColorEntryAsRGB;
%ignore GDALGetColorEntryCount;
%ignore GDALSetColorEntry;
