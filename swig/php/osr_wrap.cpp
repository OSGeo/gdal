...
ZEND_NAMED_FUNCTION(_wrap_GetProjectionMethodParameterList) {
    ...
    {
        /* typemap(in) SWIGTYPE * */
        if(SWIG_ConvertPtr(*args[1], (void **) &arg2, SWIGTYPE_p_p_char) < 0) {
...
ZEND_NAMED_FUNCTION(_wrap_SpatialReference___str__) {
    ...
    {
        /* typemap(in) SWIGTYPE * */
        if(SWIG_ConvertPtr(*&this_ptr, (void **) &arg1, SWIGTYPE_p_OSRSpatialReferenceShadow) < 0) {
...
ZEND_NAMED_FUNCTION(_wrap_SpatialReference_IsSame) {
    ...
    {
        /* typemap(in) SWIGTYPE * */
        if(SWIG_ConvertPtr(*args[0], (void **) &arg2, SWIGTYPE_p_OSRSpatialReferenceShadow) < 0) {
...
ZEND_NAMED_FUNCTION(_wrap_SpatialReference_GetAttrValue) {
    ...
    if(arg_count > 2) {
        {
            /*@/home/kruland/opt/share/swig/1.3.25/php4/utils.i,4,CONVERT_INT_IN@*/
...
ZEND_NAMED_FUNCTION(_wrap_SpatialReference_SetAngularUnits) {
    ...
    {
        /*@/home/kruland/opt/share/swig/1.3.25/php4/utils.i,13,CONVERT_FLOAT_IN@*/
...
ZEND_NAMED_FUNCTION(_wrap_new_CoordinateTransformation) {
    ...
    {
        /* typemap(in) SWIGTYPE * */
        if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_OSRSpatialReferenceShadow) < 0) {
    ...
    {
        /* typemap(in) SWIGTYPE * */
        if(SWIG_ConvertPtr(*args[1], (void **) &arg2, SWIGTYPE_p_OSRSpatialReferenceShadow) < 0) {
...
ZEND_NAMED_FUNCTION(_wrap_CoordinateTransformation_TransformPoint__SWIG_0) {
    ...
    {
        /* typemap(in) SWIGTYPE * */
        if(SWIG_ConvertPtr(*&this_ptr, (void **) &arg1, SWIGTYPE_p_OSRCoordinateTransformationShadow) < 0) {
...
ZEND_NAMED_FUNCTION(_wrap_CoordinateTransformation_TransformPoint) {
    ...
    if (argc == 2) {
        int _v;
        {
            /* typecheck SWIGTYPE * */
            void *tmp;
            _v = (SWIG_ConvertPtr( *argv[0], (void**)&tmp, SWIGTYPE_p_OSRCoordinateTransformationShadow) < 0)? 0 : 1;
        }
        if (_v) {
            {
                /* typecheck SWIGTYPE * */
                void *tmp;
                _v = (SWIG_ConvertPtr( *argv[1], (void**)&tmp, SWIGTYPE_p_double) < 0)? 0 : 1;
            }
            if (_v) {
    ...
    if ((argc >= 3) && (argc <= 4)) {
        ...
        if (_v) {
            _v = Z_TYPE_PP(argv[1]) == IS_DOUBLE ? 1 : 0; 
            if (_v) {
                _v = Z_TYPE_PP(argv[2]) == IS_DOUBLE ? 1 : 0; 
                if (_v) {
                    if (argc <= 3) {
                        return _wrap_CoordinateTransformation_TransformPoint__SWIG_1(INTERNAL_FUNCTION_PARAM_PASSTHRU);
                    }
                    _v = Z_TYPE_PP(argv[3]) == IS_DOUBLE ? 1 : 0; 
                    if (_v) {
                        return _wrap_CoordinateTransformation_TransformPoint__SWIG_1(INTERNAL_FUNCTION_PARAM_PASSTHRU);
                    }
                }
