...
foreach(_FILE IN ITEMS gdal_wrap.cpp gdalconst_wrap.c ogr_wrap.cpp osr_wrap.cpp gdal_array_wrap.cpp gnm_wrap.cpp)
    file(READ ${CMAKE_CURRENT_BINARY_DIR}/extensions/${_FILE} _CONTENTS)
    ...
    if("${_FILE}" STREQUAL "gdal_wrap.cpp")
        string(REGEX REPLACE "result = \\(CPLErr\\)([^;]+)(\\;)"
                             [[CPL_IGNORE_RET_VAL(result = (CPLErr)\1)\2]]
               _CONTENTS "${_CONTENTS}")
    endif()

    if(NOT "${_FILE}" STREQUAL "gdal_array_wrap.cpp")
    ...
    file(WRITE ${CMAKE_CURRENT_BINARY_DIR}/extensions/${_FILE} "${_CONTENTS}")
endforeach()
