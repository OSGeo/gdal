...
# endif
  ...
  SWIG_Python_SetConstant(d, "GRIORA_AverageQuadratic",SWIG_From_int((int)(GRIORA_AverageQuadratic)));
  ...
  SWIG_Python_SetConstant(d, "GRA_AverageQuadratic",SWIG_From_int((int)(GRA_AverageQuadratic)));
