...
sudo chroot "$chroot" sh -c "cd $PWD/proj && make -j3 install && mv /usr/local/lib/libproj.so.13.1.1 /usr/local/lib/libinternalproj.so.13.1.1 && rm /usr/local/lib/libproj.so* && ln -s libinternalproj.so.13.1.1  /usr/local/lib/libinternalproj.so.13 && ln -s libinternalproj.so.13.1.1  /usr/local/lib/libinternalproj.so"
