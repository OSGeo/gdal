...
GRIB1ParmTable parm_table_ncep_opn[256] = {
   ...
   /* 128 */ {"MSLSA", "Mean sea level pressure (Std Atm Reduction)", "Pa",
              UC_NONE},
   /* 129 */ {"MSLMA", "Mean sea level pressure (MAPS system Reduction)", "Pa",
              UC_NONE},
   /* 130 */ {"MSLET", "Mean sea level pressure (ETA model Reduction)", "Pa",
              UC_NONE},
   /* 131 */ {"LFTX", "Surface lifted index", "K", UC_NONE},
              /* Delta temp. */
   ...
   /* 137 */ {"TSLSA", "3-hr pressure tendency (Std Atmos Reduction)", "Pa/s",
              UC_NONE},
   /* 138 */ {"BVF2", "Brunt-Vaisala frequency (squared)", "1/s^2", UC_NONE},
   /* 139 */ {"PVMW", "Potential vorticity (density weighted)", "1/s/m",
              UC_NONE},
   ...
   /* 186 */ {"TIPD", "Turbulence Icing Potential Diagnostic", "-", UC_NONE},
   /* 187 */ {"LTNG", "Lightning", "-", UC_NONE},
   /* 188 */ {"RDRIP", "Rate of water dropping from canopy to ground", "-",
              UC_NONE},
   ...
   /* 192 */ {"PROBN", "Probability from ensemble normalized with respect to climate expectancy", "-",
              UC_NONE},
   ...
   /* 224 */ {"SOTYP", "Soil type", "Zobler 0..9", UC_NONE},
   ...
   /* 236 */ {"SIPD", "Supercooled Large Droplet (SLD) Icing Potential Diagnostic",
              "-", UC_NONE},
...
GRIB1ParmTable parm_table_nceptab_129[256] = {
   ...
   /* 136 */ {"TCOLW", "Total column-integrated cloud water", "kg/m/m", UC_NONE},
   /* 137 */ {"TCOLI", "Total column-integrated cloud ice", "kg/m/m", UC_NONE},
   /* 138 */ {"TCOLR", "Total column-integrated rain", "kg/m/m", UC_NONE},
   /* 139 */ {"TCOLS", "Total column-integrated snow", "kg/m/m", UC_NONE},
   /* 140 */ {"TCOLC", "Total column-integrated condensate", "kg/m/m", UC_NONE},
   ...
   /* 171 */ {"TSEC", "Seconds prior to initial reference time (defined in bytes 18-20)",
              "sec", UC_NONE},
...
GRIB1ParmTable parm_table_nceptab_130[256] = {
   ...
   /* 143 */ {"var143", "undefined", "-", UC_NONE},
   /* 144 */ {"SOILW", "Volumetric soil moisture (frozen + liquid)",
              "fraction", UC_NONE},
   /* 145 */ {"PEVPR", "Potential latent heat flux (potential evaporation",
              "W/m^2", UC_NONE},
   ...
   /* 160 */ {"SOILL", "Liquid volumetric soil moisture (non-frozen)",
              "Kg/m^2", UC_NONE},
...
/* Not sure if 171 is reserved or is # of soil layers... */
   ...
   /* 176 */ {"NLAT", "Latitude (-90 to +90)", "deg", UC_NONE},
   /* 177 */ {"ELON", "East Longitude (0-360)", "deg", UC_NONE},
   /* 178 */ {"FLDCAP", "Field Capacity (soil moisture)", "fraction",
              UC_NONE},
   /* 179 */ {"ACOND", "Aerodynamic conductance", "m/s", UC_NONE},
   /* 180 */ {"SNOAG", "Snow age", "s", UC_NONE},
   /* 181 */ {"CCOND", "Conopy conductance", "m/s", UC_NONE},
   /* 182 */ {"LAI", "Leaf area index (0-9)", "-", UC_NONE},
   /* 183 */ {"SFCRH", "Roughness length for heat", "m", UC_NONE},
   /* 184 */ {"SALBD", "Snow albedo (over snow area only)", "%", UC_NONE},
   /* 185 */ {"var185", "undefined", "-", UC_NONE},
   /* 186 */ {"var186", "undefined", "-", UC_NONE},
   /* 187 */ {"NDVI", "Normalized Difference Vegetation Index (NDVI)", "-",
              UC_NONE},
   ...
   /* 221 */ {"HPBL", "Planetary boundary layer height", "-", UC_NONE},
   ...
   /* 228 */ {"PEVAP", "Potential evaporation", "Kg/m^2", UC_NONE},
   /* 229 */ {"SNOHF", "Snow phase-change heat flux", "W/m^2", UC_NONE},
   /* 230 */ {"SMREF", "Transpiration stress-onset (soil moisture)",
              "fraction", UC_NONE},
   ...
   /* 246 */ {"RCS", "Solar parameter in canopy conductance", "fraction",
              UC_NONE},
   /* 247 */ {"RCT", "Temperature parameter in canopy conductance",
              "fraction", UC_NONE},
   /* 248 */ {"RCQ", "Humidity parameter in canopy conductance", "fraction",
              UC_NONE},
   /* 249 */ {"RCSOL", "Soil moisture parameter in canopy conductance",
              "fraction", UC_NONE},
   /* 250 */ {"var250", "undefined", "-", UC_NONE},
   /* 251 */ {"var251", "undefined", "-", UC_NONE},
...
GRIB1ParmTable parm_table_nceptab_131[256] = {
   ...
   /* 170 */ {"SNFALB", "Snow-free albedo", "%", UC_NONE},
   /* 171 */ {"RLYRS", "Number of soil layers in root zone", "-", UC_NONE},
   /* 172 */ {"FLX", "Momentum flux", "N/m^2", UC_NONE},
   /* 173 */ {"LMH", "Mass point model surface", "-", UC_NONE},
   /* 174 */ {"LMV", "Velocity point model surface", "-", UC_NONE},
   /* 175 */ {"MLYNO", "Model layer number (from bottom up)", "-", UC_NONE},
   /* 176 */ {"NLAT", "Latitude (-90 to +90)", "deg", UC_NONE},
   ...
   /* 196 */ {"USTM", "u-component of storm motion", "m/s", UC_NONE},
   /* 197 */ {"VSTM", "v-component of storm motion", "m/s", UC_NONE},
   /* 198 */ {"SBSNO", "Sublimation (evaporation from snow)", "W/m2", UC_NONE},
   /* 199 */ {"EVBS", "Direct evaporation from bare soil", "W/m^2", UC_NONE},
   /* 200 */ {"EVCW", "Canopy water evaporation", "W/m^2", UC_NONE},
   /* 201 */ {"var201", "undefined", "-", UC_NONE},
