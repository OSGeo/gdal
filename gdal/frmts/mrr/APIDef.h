...
extern "C"
{
    ...
    */
    ...
    /*!    \enum    MIR_StatisticsMode
        \brief    Statistics calculation mode.
    */
    enum MIR_StatisticsMode
    {
    ...
    */
    ...
    /*!    \enum    MIR_RasterizeOperator
        \brief    Rasterize operation operator.
    */
    enum MIR_RasterizeOperator
    {
    ...
    */
    ...
    //struct SMIR_InputRasterDetail
    //{
    //    const wchar_t* ppwsInputRasterFilePath;
    //    SMIR_FieldBandFilter cFieldBandFilter;
    //
    //    SMIR_InputRasterDetail() : ppwsInputRasterFilePath(0), cFieldBandFilter(0u)
    //    {}
    //};
    ...
    */enum MIR_Stamp_StampMethod
    {
        MIR_Stamp_FirstOnly = 0, /*!< First only stamping method.*/
        MIR_Stamp_LastOnly,    /*!< Last only stamping method.*/
        MIR_Stamp_Sum, /*!< Sum all stamping method.*/
        MIR_Stamp_Minimum, /*!< Use minimum value stamping method.*/
        MIR_Stamp_Maximum, /*!< Use maximum value stamping method.*/
        MIR_Stamp_AverageLastInWeighted /*!< Average all (last in weighted) stamping method.*/
    };
    ...
    */
    struct SMIR_IMP_Triangulation
    {
        ...
        uint8_t                    nPatchMultiplier; /*!< Multiplier used to increase the patch size.*/
    ...
    */
    struct SMIR_IMP_Stamp
    {
        MIR_Stamp_StampMethod    nStampMethod; /*!< Stamping method to use. Only MIR_Stamp_FirstOnly, MIR_Stamp_LastOnly and MIR_Stamp_AverageLastInWeighted are valid.*/
        SMIR_IMP_Clip            cClip; /*!< Structure defining clipping parameters.*/
        SMIR_IMP_Smoothing        cSmoothing; /*!< Smoothing parameters to be applied post processing.*/
    };
