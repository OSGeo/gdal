...
- `CartoDB <http://www.cartodb.com>`_ A cloud mapping platform to analyze and visualize geospatial data.
...
- `Demeter <http://www.terrainengine.com>`_ Another OpenGL based terrain engine somewhat similar to VTP.
- `Depiction <http://www.depiction.com>`_ Depiction Mapping, simulation and collaboration software.
...
- `EOxServer <http://www.eoxserver.org>`_  OGC-compliant server for Earth Observation (EO) data supporting WMS and WCS with EO application profiles.
- `ERDAS ER Viewer  <http://www.erdas.com/tabid/84/currentid/2585/default.aspx>`_ Image viewer for very large JPEG 2000 and ECW files.
...
- `Fortified GIS VantagePoint  <http://www.fortifiedgis.com/products/desktop>`_  GIS desktop viewer and analysis tool.
...
- `GenGIS  <http://kiwi.cs.dal.ca/GenGI>`_  Software for geospatial analysis of genetic data.
...
- `GeoServer  <http://geoserver.org/display/GEOS/Welcome>`_  a open source software server written in Java that allows users to share and edit geospatial data.
...
- `gvSIG  <http://www.gvsig.gva.es>`_  Desktop GIS Client.
...
- `Image I/O-Ext  <https://imageio-ext.dev.java.net>`_  includes gdalframework, a framework leveraging on GDAL via SWIG's generated JAVA bindings to provide support for a broad set of data formats.
...
- `IntraMap  <http://www.ksic.net>`_  A GIS Software for spatial data display/management, spatial inquiries, and many other various analyses.
- `IONIC Red Spicer  <http://www.ionicsoft.com>`_  an OGC Web Services platform that includes a GDAL plugin.
- `iShare  <http://astuntechnology.com/ishare>`_  Web data integration and publishing platform by Astun Technology.
- `LandXplorer  <http://www.3dgeo.de>`_  A realtime 3D visualization system for 3D city and landscape models.
- `Leica TITAN  <http://www.lggi.com/titan>`_  a geospatial data sharing and visualization environment.
- `libLAS  <http://liblas.org/wiki>`_  Open Source LAS 1.0/1.1 ASPRS LiDAR data translation toolset
...
- `MapTiler  <http://www.maptiler.co/>`_  Generator of tiles for interactive maps and overlays made from raster images and geodata.
...
- `NASA Ames Stereo Pipeline  <http://ti.arc.nasa.gov/tech/asr/intelligent-robotics/ngt/stereo>`_  Software for creating terrain models and ortho images from planetary stereo images.
...
- `OpenCPN  <http://opencpn.org/ocpn>`_  A concise ChartPlotter/Navigator. A cross-platform ship-borne GUI application.
...
- `PostGIS  <http://www.postgis.org>`_ spatial database extender for PostgreSQL: The raster loader and many of the raster SQL functions rely on GDAL.
...
- `Rasterix  <https://github.com/mogasw/rasterix/>`_ Rasterix: A cross platform open source utility to process raster data based on Qt and GDAL.
...
- `ScanMagic  <http://www.scanex.ru/software/scanmagic>`_ Win32 application for visualization, analysis and processing of remote sensing data.
...
- `Scenomics  <http://www.scenomics.com>`_ Scenomics: Software for building terrain databases uses GDAL for projection and data import/export.
...
- `SpaceEyes3D  <http://www.spaceyes.com>`_  3D visualization software for cartographic data.
...
- `TacitView  <http://www.2d3.com/product>`_  An imagery visualization and exploitation package for military intelligence.
...
- `vGeo <http://www.vrco.com/vGeo/OverviewvGeo.html>`_  Interactive data fusion and visual analysis tool.
