...
constexpr static const char* const apszKnownConfigOptions[] =
{
   ...
   "CPL_DEBUG", // from cpl_conv.cpp, cpl_error.cpp, cpl_http.cpp, gdalabstractbandblockcache.cpp, gdalinfo_bin.cpp, gdalsrsinfo.cpp, gdalwarp_bin.cpp, ogrgmlasreader.cpp
