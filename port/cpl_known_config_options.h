...
constexpr static const char* const apszKnownConfigOptions[] =
{
   ...
   "GDAL_EXPRTK_ENABLE_LOOPS", // from vrtexpression.cpp
   "GDAL_EXPRTK_MAX_EXPRESSION_LENGTH", // from vrtexpression.cpp
   "GDAL_EXPRTK_MAX_VECTOR_LENGTH", // from vrtexpression.cpp
   "GDAL_EXPRTK_TIMEOUT_SECONDS", // from vrtexpression.cpp
